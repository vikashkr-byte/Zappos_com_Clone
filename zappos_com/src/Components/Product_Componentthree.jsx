  ...
  return (
    <Grid templateColumns={['repeat(1, 1fr)','repeat(3, 1fr)']} gap={2} >
      ...
      <Box p="4" bg="white">
        <Box>
          <Image
            src="https://m.media-amazon.com/images/G/01/2022/homepage9.26/COOP-SOREL-NEW-ARRIVALS-DESKTOP-LEFT-2X-1268x1268.jpg"
            alt="zapposTwo_"
          />
        </Box>
        <Box pt="10px" textAlign="center" lineHeight="25px" >
...
export default Product_Componentthree